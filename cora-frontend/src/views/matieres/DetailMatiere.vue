...
<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <!-- Hero Section -->
    <div
      class="relative bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 overflow-hidden"
    >
      <!-- Pattern de fond -->
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="text-white">
            ...
            <!-- Bouton principal -->
            <button
              class="px-8 py-4 bg-white text-blue-600 font-bold rounded-xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all flex items-center gap-3"
            >
              <svg
                class="w-6 h-6"
                fill="none"
          ...
          <!-- Stats card -->
          <div
            class="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 shadow-2xl"
          >
            <h3 class="text-white text-xl font-bold mb-6">Aperçu du cours</h3>

            <div class="grid grid-cols-2 gap-6 mb-8">
              <div
                class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20"
              >
      ...
      <div v-if="tabActif === 'cours'">
        <div class="mb-8">
          ...
          <p class="text-gray-600">
            Cliquez sur un cours pour accéder à ses chapitres et leçons
          </p>
        </div>
          ...
          >
            ...
            >
              ...
              <div class="absolute top-4 right-4">
                <span
                  v-if="cours.completed"
                  class="px-4 py-2 bg-green-500 text-white text-sm font-semibold rounded-full shadow-lg"
                >
                  ✓ Terminé
                </span>
                <span
                  v-else-if="cours.enCours"
                  class="px-4 py-2 bg-yellow-500 text-white text-sm font-semibold rounded-full shadow-lg"
                >
                  ⏳ En cours
                </span>
                <span
                  v-else-if="cours.verrouille"
                  class="px-4 py-2 bg-gray-500 text-white text-sm font-semibold rounded-full shadow-lg"
                >
                  🔒 Verrouillé
                </span>
                <span
                  v-else
                  class="px-4 py-2 bg-blue-500 text-white text-sm font-semibold rounded-full shadow-lg"
                >
                  ⭐ Disponible
                </span>
              </div>
              ...
              <!-- Icône centrale -->
              <div
                class="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center text-5xl group-hover:scale-110 transition-transform"
              >
                {{ cours.icon }}
              </div>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          ...
          <div class="prose prose-lg text-gray-600 leading-relaxed space-y-4">
            ...
            <p>
              ...
              pour être interactive et engageante, avec des exemples concrets et
              des exercices pratiques.
            </p>
            <p>
              Vous apprendrez à votre rythme, avec un suivi personnalisé de
              votre progression et des feedbacks détaillés sur vos performances.
            </p>
          </div>
        </div>
      </div>
      ...
      <div v-else-if="tabActif === 'objectifs'" class="max-w-4xl">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          ...
          <div class="space-y-4">
            ...
            >
              <div
                class="w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold"
              >
                {{ index + 1 }}
              </div>
