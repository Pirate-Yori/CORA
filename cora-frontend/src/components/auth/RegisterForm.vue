...
<template>
  <div class="w-full h-full grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 max-h-screen">
    ...
    <!-- Formulaire à droite -->
    <div class="w-full flex flex-col justify-center py-4 lg:py-0 overflow-y-auto lg:overflow-visible">
    <!-- Tabs Login/Register -->
    ...
    <form @submit.prevent="handleRegister" class="space-y-3">
      ...
      <!-- Classe -->
      <div>
        <label for="classe" class="block text-sm font-medium text-gray-700 mb-1.5">
          Classe
        </label>
        <div class="relative">
          ...
          <select
            ...
            :class="{ 'border-red-500 focus:ring-red-500 bg-red-50': errors.classe }"
          >
      ...
      >
        ...
        <template #append>
          ...
          >
            ...
            <svg v-else class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
            </svg>
          </button>
        </template>
      </AppInput>
