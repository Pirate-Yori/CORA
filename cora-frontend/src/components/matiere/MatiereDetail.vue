      ...
      <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex items-center gap-3">
            <button class="hidden sm:flex items-center gap-2 px-4 py-2  hover:bg-gray-100 rounded-lg transition-colors text-sm font-medium">
      ...
      >
        <div class="p-6 border-b border-gray-200">
          ...
          <div>
            <div class="flex items-center justify-between mb-2">
              <span class="text-xs font-medium ">Progression</span>
        ...
        <nav class="p-4">
          <div v-for="chapitre in cours.chapitres" :key="chapitre.id" class="mb-6">
            ...
            >
              <div class="flex items-center gap-3">
                <div class="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center text-sm font-semibold  group-hover:bg-blue-100 group-hover:text-blue-600 transition-colors">
                  {{ chapitre.numero }}
                </div>
            ...
            >
              ...
              >
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <h4 :class="[
                    'text-sm font-medium',
                    leconActive.id === lecon.id ? 'text-blue-700' : ' group-hover:text-gray-900'
                  ]">
                    {{ lecon.titre }}
                  </h4>
                </div>
        ...
        <div class="max-w-4xl mx-auto p-6 lg:p-8">
          ...
          <div class="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-2xl p-8 border border-purple-200 mb-8">
            <div class="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p class="">Testez vos connaissances avec 8 exercices</p>
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <div class="flex items-center justify-between mb-2">
                  <span class="text-sm font-semibold ">Exercice {{ exercice.numero }}</span>
                ...
                <p class="text-sm  mb-3">{{ exercice.question }}</p>
          ...
          <div class="flex items-center justify-between border-t border-gray-200 pt-8">
            <button 
              ...
              class="flex items-center gap-2 px-6 py-3 bg-white border border-gray-300 hover:border-gray-400 rounded-xl transition-colors  font-medium"
            >
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
