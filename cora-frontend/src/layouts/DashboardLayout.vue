<template>
  <div class="flex h-screen bg-gray-50 overflow-hidden">
    ...
    >
      ...
      >
        <router-link to="/dashboard" class="flex items-center gap-3">
          <div
            class="w-10 h-10 bg-linear-to-br from-blue-600 to-indigo-600 rounded-xl flex items-center justify-center"
          >
            <svg
      ...
      <nav class="flex-1 px-4 py-6 overflow-y-auto">
        <div class="space-y-1">
          <!-- Accueil -->
          <router-link to="/dashboard" v-slot="{ isActive }" custom>
            <a
          ...
          <!-- Mes Matières -->
          <router-link to="/matieres" v-slot="{ isActive }" custom>
            <a
              @click="navigateTo('/matieres')"
              :class="[
                'flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-all cursor-pointer',
                isActive
                  ? 'bg-blue-50 text-blue-700'
          ...
          <!-- Devoirs -->
          <router-link to="/devoirs" v-slot="{ isActive }" custom>
            <a
              @click="navigateTo('/devoirs')"
              :class="[
                'flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-all cursor-pointer',
                isActive
                  ? 'bg-blue-50 text-blue-700'
            ...
            >
              ...
              <span>Devoirs</span>
              <span
                class="ml-auto bg-orange-100 text-orange-700 text-xs font-semibold px-2 py-1 rounded-full"
              >
                5
              </span>
            </a>
          ...
          <!-- Progression -->
          <router-link to="/progression" v-slot="{ isActive }" custom>
            <a
          ...
          <!-- Calendrier -->
          <router-link to="/calendrier" v-slot="{ isActive }" custom>
            <a
          ...
          <!-- Messages -->
          <router-link to="/messages" v-slot="{ isActive }" custom>
            <a
        ...
        <div class="mt-8 pt-8 border-t border-gray-200">
          ...
          <router-link to="/profil" v-slot="{ isActive }" custom>
            <a
          ...
          <router-link to="/parametres" v-slot="{ isActive }" custom>
            <a
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      <!-- Header mobile -->
      <header
        class="lg:hidden h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4"
      >
        <button
        ...
        <div class="flex items-center gap-3">
          ...
          <span
            class="text-lg font-bold bg-linear-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent"
          >
            Cora
          </span>
        </div>
